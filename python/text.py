...
#for i in test:
#    makeword(i)
test = ["매출액에누리","매출액", "제품매출액",  "에누리", "이월에누리매출액"]
#print(totalword("조희성 우리_가족 사랑해"))
lis =re.split("[^a-zA-Z가-힣]", "조희성 우리_가족 사랑해")
...
x_test_key = tokenizer.texts_to_sequences(realarr.values())
