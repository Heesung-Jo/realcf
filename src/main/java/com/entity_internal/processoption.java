...
@Entity
@Table
public class processoption implements Cloneable{ 
	 ...
	 //private boolean incompletepoint;  // 미비점이냐 아니냐를 집계하기 위해서 만들었음   
	 ...
	 /* 무조건 하나당 값 하나로 받도록 수정하였음 
	 @JsonIgnore  // 나중에 옵션값이 선택된 결과값을 받을 변수
	 @OneToMany(mappedBy = "processoption", cascade = CascadeType.ALL)
	 private List<result_value> result_value = new ArrayList<>();
	 */
	 ...
	 // 미비점 띄울때 이유를 표시하기 위해서 추가한 열임
	 private String riskreason1;
	 private String riskreason2;
	 private String riskreason3;
	 private String riskreason4;
	 private String riskreason5;
